			...
			<div class="col-sm-3">
				...
				<div>
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("pc" , "laptop") LIMIT 3,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("pc" , "laptop") LIMIT 1,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("pc" , "laptop") LIMIT 4,1' ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("pc" , "laptop") LIMIT 2,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("pc" , "laptop") LIMIT 5,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				...
				<div>
					<?php
						#$get_pro = 'SELECT * FROM products where product_category IN("mobile" , "tablet")
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 3,1' ;
						$get_pro = 'SELECT * FROM products where product_category IN("mobile" , "tablet") LIMIT 3,1' ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						#$get_pro = 'SELECT * FROM products where product_category IN("mobile" , "tablet")
								#ORDER BY product_uploadTimeAndDate DESC LIMIT 1,1' ;
						$get_pro = 'SELECT * FROM products where product_category IN("mobile" , "tablet") LIMIT 1,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("mobile" , "tablet") LIMIT 4,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("mobile" , "tablet") LIMIT 2,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("mobile" , "tablet") LIMIT 5,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				...
				<div>
					<?php
						#$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr")
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 3,1' ;
						$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr") LIMIT 3,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						#$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr")
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 1,1' ;
            $get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr") LIMIT 1,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						#$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr")
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 4,1' ;
						$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr") LIMIT 4,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						#$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr")
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 2,1' ;
						$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr") LIMIT 2,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						#$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr")
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 5,1' ;
						$get_pro = 'SELECT * FROM products where product_category IN("tv" , "dslr") LIMIT 5,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				...
				<div>
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("watch" , "sunglass") LIMIT 3,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						#$get_pro = 'SELECT * FROM products where product_category IN("watch" , "sunglass") ORDER BY product_uploadTimeAndDate DESC LIMIT 1,1' ;
 						$get_pro = 'SELECT * FROM products where product_category IN("watch" , "sunglass") LIMIT 1,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("watch" , "sunglass") LIMIT 4,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("watch" , "sunglass") LIMIT 2,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						...
						$get_pro = 'SELECT * FROM products where product_category IN("watch" , "sunglass") LIMIT 5,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				...
				<div>
					<?php
						#$get_pro = 'SELECT * FROM products where product_category = "cloth"
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 3,1' ;
						$get_pro = 'SELECT * FROM products where product_category = "cloth" LIMIT 3,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						#$get_pro = 'SELECT * FROM products where product_category = "cloth"
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 1,1' ;
						$get_pro = 'SELECT * FROM products where product_category = "cloth" LIMIT 1,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						#$get_pro = 'SELECT * FROM products where product_category = "cloth"
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 4,1' ;
						$get_pro = 'SELECT * FROM products where product_category = "cloth" LIMIT 4,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
			...
			<div class="col-sm-3">
				<div class="mt-2">
					<?php
						#$get_pro = 'SELECT * FROM products where product_category = "cloth"
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 2,1' ;
						$get_pro = 'SELECT * FROM products where product_category = "cloth" LIMIT 2,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
				...
				<div>
					<?php
						#$get_pro = 'SELECT * FROM products where product_category = "cloth"
									#ORDER BY product_uploadTimeAndDate DESC LIMIT 5,1' ;
						$get_pro = 'SELECT * FROM products where product_category = "cloth" LIMIT 5,1' ;
						$run_pro = mysqli_query($con , $get_pro) ;
						$row_pro = mysqli_fetch_array($run_pro) ;
						$product_name = $row_pro['product_name'] ;
						$product_price = $row_pro['product_price'] ;
